    ...
    <div class="max-w-7xl mx-auto">
      <div class="bg-black rounded-xl shadow-2xl p-6 sm:p-8 lg:p-12">
        ...
        <section class="mb-8 sm:mb-12">
          ...
          <p class="text-base sm:text-lg text-gray-300 leading-relaxed">{{ t('backendCapabilitiesOverview') }}</p>
        </section>
...
const gridItems = computed((): BackendGridItem[] => [
  createGridItem('', t('scalability'), t('scalabilityDescription'), '', '', ''),
  createGridItem('', t('security'), t('securityDescription'), '', '', ''),
  createGridItem('', t('performanceOptimization'), t('performanceOptimizationDescription'), '', '', ''),
  createGridItem('', t('maintainability'), t('maintainabilityDescription'), '', '', ''),
  createGridItem('', t('testingAndQualityAssurance'), t('testingAndQualityAssuranceDescription'), '', '', ''),
  createGridItem('', t('monitoringAndLogging'), t('monitoringAndLoggingDescription'), '', '', ''),
])
</script>
