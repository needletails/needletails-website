...
const translations = {
  'es': {
    ...
    nudgeKitMetaKeywords: "NudgeKit, SDK Swift, cifrado de extremo a extremo, mensajería segura, SDK iOS, SDK macOS, SDK Android, criptografía post-cuántica"
  },
  'fr': {
    ...
    nudgeKitMetaKeywords: "NudgeKit, SDK Swift, chiffrement de bout en bout, messagerie sécurisée, SDK iOS, SDK macOS, SDK Android, cryptographie post-quantique"
  },
  'de': {
    ...
    nudgeKitMetaKeywords: "NudgeKit, Swift SDK, Ende-zu-Ende-Verschlüsselung, sichere Messaging, iOS SDK, macOS SDK, Android SDK, Post-Quanten-Kryptographie"
  },
  'zh-cn': {
    ...
    nudgeKitMetaKeywords: "NudgeKit, Swift SDK, 端到端加密, 安全消息, iOS SDK, macOS SDK, Android SDK, 后量子密码学"
  },
  'zh-tw': {
    ...
    nudgeKitMetaKeywords: "NudgeKit, Swift SDK, 端到端加密, 安全訊息, iOS SDK, macOS SDK, Android SDK, 後量子密碼學"
  },
  'ja': {
    ...
    nudgeKitMetaKeywords: "NudgeKit, Swift SDK, エンドツーエンド暗号化, 安全なメッセージング, iOS SDK, macOS SDK, Android SDK, ポスト量子暗号"
  },
  'pt': {
    ...
    nudgeKitMetaKeywords: "NudgeKit, SDK Swift, criptografia de ponta a ponta, mensagens seguras, SDK iOS, SDK macOS, SDK Android, criptografia pós-quântica"
  },
  'it': {
    ...
    nudgeKitMetaKeywords: "NudgeKit, SDK Swift, crittografia end-to-end, messaggistica sicura, SDK iOS, SDK macOS, SDK Android, crittografia post-quantistica"
  },
  'nl': {
    ...
    nudgeKitMetaKeywords: "NudgeKit, Swift SDK, end-to-end versleuteling, veilige berichten, iOS SDK, macOS SDK, Android SDK, post-quantum cryptografie"
  },
  'ko': {
    ...
    nudgeKitMetaKeywords: "NudgeKit, Swift SDK, 엔드투엔드 암호화, 안전한 메시징, iOS SDK, macOS SDK, Android SDK, 후양자 암호학"
  },
  'tr': {
    ...
    nudgeKitMetaKeywords: "NudgeKit, Swift SDK, uçtan uca şifreleme, güvenli mesajlaşma, iOS SDK, macOS SDK, Android SDK, kuantum sonrası kriptografi"
  },
  'he': {
    ...
    nudgeKitMetaKeywords: "NudgeKit, SDK Swift, הצפנה מקצה לקצה, הודעות מאובטחות, SDK iOS, SDK macOS, SDK Android, קריפטוגרפיה פוסט-קוונטית"
  }
};
